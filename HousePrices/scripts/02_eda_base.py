...
report_dir = 'C:\\Users\\User\\Documents\\Kaggle\\HousePrices\\report\\'
...
# extract the different column types
num_cols =  base.dtypes.index[(base.dtypes == 'int64') | (base.dtypes == 'float64')].tolist()
...
va.vis_hist(dataset = base,
            num_var = ['SalePrice', 'logSalePrice'],
            bins = None,
            hist = True,
            kde = False
            )
