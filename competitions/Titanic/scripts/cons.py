...
# set base columns
sub_cols = ['PassengerId', 'Survived', 'Pclass', 'Age', 'SibSp', 'Parch', 'FamSize', 'Fare', 'Alone', 'Mr', 'Mrs', 'Ms', 'Priv', 'Male', 'Embarked_Ord', 'Dataset']

# the title of a person indicates the person status
title_map = {'Mr':'Mr', 'Miss':'Ms', 'Mrs':'Mrs', 'Master':'Master', 'Dr':'Dr', 'Rev':'Rev', 'Col':'Col', 'Major':'Major', 'Ms':'Ms', 'Mlle':'Ms', 'Capt':'Capt', 'Don':'Mr', 'Jonkheer':'Jonkheer', 'Sir':'Sir', 'Lady':'Lady', 'Mme':'Mrs', 'Dona':'Mrs', 'theCountess':'Countess'}
